<?php
    ...
    $_SESSION["allMongoDBComments"] = $mongoDBWriter->getAllCommentsFromMongoDB();
    $allMongoDBComments = $_SESSION["allMongoDBComments"];
?>
...
<body>
    <div class="my-div">
        <h1><font color=#42f5b3> Comments </font> MongoDB-Data</h1>
        ...
        <?php
            if ($_SESSION["migrationToMongoStarted"] == false) {
                ...
                //* All Users
                if ($allMongoDBComments !== null) {
                    foreach ($allMongoDBComments as $element) {
                        echo "<pre>";
                            print_r($element);
                        echo "</pre>";
                    }
