<?php
    ...
    $_SESSION["actualMongoDBListRecipes"] = $mongoDBWriter->getAllListRecipesFromMongoDBUpdate();
    $allMongoDBListRecipes = $_SESSION["actualMongoDBListRecipes"];
?>
...
<body>
    <div class="my-div">
        <h1><font color=#42f5b3> ListRecipe </font> MongoDB-Data</h1>
        ...
        <?php
            if ($_SESSION["migrationToMongoStarted"] == false) {
                ...
                //* All Users
                if ($allMongoDBListRecipes !== null) {
                    foreach ($allMongoDBListRecipes as $element) {
                        echo "<pre>";
                            print_r($element);
                        echo "</pre>";
                    }
